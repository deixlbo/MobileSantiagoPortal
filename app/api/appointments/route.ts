    ...
    await supabase.from('notification_logs').insert([
      {
        ...
        recipient: 'resident@email.com', // Fetch actual email
        subject: 'Appointment Confirmed',
        body: `Your appointment has been scheduled for ${new Date(scheduledAt).toLocaleDateString()}. Purpose: ${purpose}`,
        status: 'sent',
        triggered_by: 'appointment_booked',
