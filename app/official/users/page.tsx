...
const rolePermissions = [
  {
    role: "Admin",
    permissions: ["View All Data", "Approve/Decline Requests", "Manage Users", "Generate Reports", "Edit Settings"],
    badge: "bg-red-100 text-red-700",
    description: "Full system access and management capabilities",
  },
  {
    role: "Official",
    permissions: ["View All Data", "Approve/Decline Requests", "Sign Documents", "View Reports"],
  ...
  return (
    ...
    >
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                { user: "Maria Cruz", action: "Declined Clearance Request", time: "10 hours ago", type: "warning" },
              ].map((log, idx) => (
      ...
      <Dialog open={showAddDialog} onOpenChange={setShowAddDialog}>
        <DialogContent className="w-[95vw] sm:w-auto max-h-[95vh] overflow-auto max-w-md mx-4 md:mx-auto">
          <DialogHeader>
