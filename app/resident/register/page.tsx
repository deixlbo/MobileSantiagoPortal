  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col md:hidden">
        ...
        <div 
          className="relative h-[35vh] bg-cover bg-center bg-no-repeat"
          style={{
        ...
        <div className="relative flex-1 -mt-6 rounded-t-3xl bg-background px-5 pb-8 pt-14">
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-muted-foreground mt-1">Register as Resident</p>
          </div>
      ...
      {/* Desktop Layout */}
      <div className="relative hidden min-h-screen items-center justify-center overflow-hidden py-8 md:flex">
        {/* Background Image */}
        <div 
        ...
        <motion.div
          ...
          className="relative z-10 mx-4 w-full max-w-lg ml-auto mr-16 lg:mr-24"
        >
