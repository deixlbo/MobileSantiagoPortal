...
function getDeploymentDomain() {
  ...
  // Default to localhost for build-only scenarios
  console.warn(
    "WARNING: No deployment domain found. Using localhost. Set REPLIT_INTERNAL_APP_DOMAIN, REPLIT_DEV_DOMAIN, or EXPO_PUBLIC_DOMAIN for production builds.",
  );
