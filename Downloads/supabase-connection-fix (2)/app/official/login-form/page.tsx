        ...
        >
          <div className="flex items-center gap-4 rounded-3xl border border-emerald-200/70 bg-emerald-50/80 p-4 shadow-sm shadow-emerald-100/60 backdrop-blur-sm max-w-max">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600">Official portal access</p>
            </div>
          </div>

          <div className="mt-8 max-w-2xl space-y-5">
            <h1 className="text-6xl font-semibold tracking-tight text-slate-950 sm:text-7xl">Official Portal Login</h1>
            <p className="text-lg leading-8 text-slate-700">
              Authorized barangay officials can sign in here to manage residents, documents, and community operations.
            </p>
          </div>
        ...
        >
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-slate-600">
              Secure access for barangay officials and administrators to manage operations and resident services.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <button
                  ...
                  className="mt-2 rounded px-3 py-2 text-sm font-medium text-slate-600 transition hover:text-slate-900"
                >
            ...
            <p className="text-sm text-slate-600">
              Need official access? Please contact your barangay administrator to request portal credentials.
            </p>
          </form>
        </motion.section>
      </div>
