        ...
        setProjects(
          Array.isArray(data)
            ? data.map((proj: any) => ({
                ...
                targetCompletion: proj.target_completion,
                projectHead: proj.project_head,
                projectHeadPosition: proj.project_head_position,
              }))
            : []
        )
      } catch (error) {
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <Dialog open={!!selectedProject} onOpenChange={() => setSelectedProject(null)}>
        <DialogContent className="w-[95vw] sm:w-auto max-h-[95vh] overflow-auto max-w-3xl">
          <DialogHeader>
