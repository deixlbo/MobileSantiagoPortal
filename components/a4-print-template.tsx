                ...
                <div className="w-full flex-1 flex flex-col justify-center">
                  {children || (
                    <div className="space-y-4 text-sm leading-relaxed">
                      ...
                      <p>THIS IS TO CERTIFY that _______________ born on ________ in ________ is a bonafide resident of Barangay Santiago, San Antonio, Zambales.</p>
                      <p>This certifies further that the above mentioned name has been living in this barangay for more than __________ years.</p>
                      <p>This certificate is issued upon the request of ________________ for any legal purpose it may serve.</p>
                      <div className="pt-4">
