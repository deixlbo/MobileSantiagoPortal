...
export type DocumentStatus = 'submitted' | 'processing' | 'approved' | 'ready' | 'rejected'
    ...
    <Card className="border-0 bg-card/60 backdrop-blur overflow-hidden">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <Badge
            variant={currentStatus === 'ready' ? 'default' : currentStatus === 'rejected' ? 'destructive' : 'secondary'}
          >
      ...
      <CardContent>
        <div className="space-y-6">
          {steps.map((step, index) => {
            const isCompleted = index < currentIndex || (index === currentIndex && currentStatus !== 'rejected')
          ...
          {currentStatus === 'rejected' && rejectionReason && (
            <div className="mt-6 rounded-lg bg-destructive/10 border border-destructive/30 p-4">
              <div className="flex gap-3">
                ...
                <div>
                  <p className="font-semibold text-destructive mb-1">Request Rejected</p>
