  ...
  appointments: [
    {
      id: 'apt-001',
      resident_id: 'resident-001',
      official_id: 'official-001',
      title: 'Document Processing Inquiry',
      description: 'Discussion about barangay certificate requirements',
    ...
    },
    {
      ...
      resident_id: 'resident-002',
      official_id: 'official-001',
      title: 'Community Program Consultation',
      description: 'Discuss community development programs',
    ...
    },
    {
      ...
      description: 'Submit and discuss business permit application',
    ...
    },
    {
      ...
      description: 'Follow up on filed complaint regarding noise disturbance',
      scheduled_date: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
      status: 'completed',
      created_at: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString(),
    },
